...
const RSSSchema = mongoose.Schema({
	...
	images: {
		...
		og: { type: String, trim: true, default: '' },
	},
	...
	interest: { type: String, default: '', index: true },
	language: { type: String, default: '' },
	consecutiveScrapeFailures: { type: Number, default: 0 },
	guidStability: {
		type: String,
	...
	toJSON: {
		transform: function(
			doc,
			ret) {/* Frontend breaks if images is null, should be {} instead*/
